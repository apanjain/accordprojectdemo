...
# Accord Protocol Template: accordprojectdemo
...
```
cicero parse --template ./accordprojectdemo/ --dsl ./accordprojectdemo/sample.txt
...
data.json:
{
   "$class": "org.apan.accorddemo.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./accordprojectdemo/ --dsl ./accordprojectdemo/sample.txt --data ./accordprojectdemo/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.apan.accorddemo.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.apan.accorddemo.Response",
